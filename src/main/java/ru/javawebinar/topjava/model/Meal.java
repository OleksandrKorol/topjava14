...
import ru.javawebinar.topjava.util.ValidationMeal;
...
public class Meal extends AbstractBaseEntity {
    ...
    @NotNull(groups = {ValidationMeal.UI.class, Default.class})
    private LocalDateTime dateTime;

    @Column(name = "description", nullable = false)
    @NotBlank(groups = {ValidationMeal.UI.class, Default.class})
    @Size(min = 2, max = 120, groups = {ValidationMeal.UI.class, Default.class})
    private String description;

    @Column(name = "calories", nullable = false)
    @Range(min = 10, max = 5000, groups = {ValidationMeal.UI.class, Default.class})
    @NotNull(groups = {ValidationMeal.UI.class, Default.class})
